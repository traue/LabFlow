// ─── SVG Icons (inline, no external CDN) ───
// All icons are from Lucide (MIT license), hand-inlined for zero dependencies.
...
export const icons = {
  ...
  chevronR:  s('<path d="m9 18 6-6-6-6"/>'),
  info:      s('<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>'),
  alertTri:  s('<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>'),
  ...
  userMinus: s('<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="22" y1="11" x2="16" y2="11"/>'),
